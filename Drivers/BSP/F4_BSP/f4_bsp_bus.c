...
/** @defgroup F4_BSP_BUS_Exported_Variables BUS Exported Variables
  * @{
  */
...
/** @defgroup F4_BSP_BUS_Private_Variables BUS Private Variables
  * @{
  */
...
/** @defgroup F4_BSP_BUS_Private_FunctionPrototypes  BUS Private Function
  * @{
  */
...
/** @defgroup F4_BSP_LOW_LEVEL_Private_Functions F4_BSP LOW LEVEL Private Functions
  * @{
  */

/** @defgroup F4_BSP_BUS_Exported_Functions F4_BSP_BUS Exported Functions
  * @{
  */
