...
void DisplayAnalogValues()
{
#if	(ANALOG_TEST==1)
	#if (GSB_HW_VER == 10)
		CDC_Tx_FS((uint8_t*)L50_menu_items_C15_2,strlen((const char*)L50_menu_items_C15_2));
		CDC_Tx_FS((uint8_t*)mystring24b,strlen((const char*)mystring24b));
	#endif
	#if (GSB_HW_VER > 10)
		CDC_Tx_FS((uint8_t*)L50_menu_items_C14_2,strlen((const char*)L50_menu_items_C14_2));
		CDC_Tx_FS((uint8_t*)mystring24a,strlen((const char*)mystring24a));
		CDC_Tx_FS((uint8_t*)L50_menu_items_C15_2,strlen((const char*)L50_menu_items_C15_2));
		CDC_Tx_FS((uint8_t*)mystring24b,strlen((const char*)mystring24b));
	#endif
	...
	CDC_Tx_FS((uint8_t*)L50_menu_items_row7a,strlen((const char*)L50_menu_items_row7a));
	CDC_Tx_FS((uint8_t*)L50_menu_items_row7b,strlen((const char*)L50_menu_items_row7b));
	CDC_Tx_FS((uint8_t*)L50_menu_items_row4a,strlen((const char*)L50_menu_items_row4a));
	#if (GSB_HW_VER > 10)
		CDC_Tx_FS((uint8_t*)L50_menu_items_row4c,strlen((const char*)L50_menu_items_row4c));
	#else
		CDC_Tx_FS((uint8_t*)L50_menu_items_row4c,strlen((const char*)L50_menu_items_row4b));
	#endif
#endif
}
...
void PrintTextHeader(const uint8_t *msg1, const uint8_t *msg2, uint8_t *ascii_val, char meas_unit[])
{
	...
	if (strlen((const char*)meas_unit))
		CDC_Tx_FS((uint8_t*)meas_unit,strlen((const char*)meas_unit));
}
...
void top_menu()
{
	...
	CDC_Tx_FS((uint8_t*)mystring0a,strlen((const char*)mystring0a));	//Transmit product string
#endif
...
#if (FACTORY_DATA)
	CDC_Tx_FS((uint8_t*)top_menu_items_row3a,strlen((const char*)top_menu_items_row3a));
#endif
#if	(OUTPUT_TEST==1)
...
void L00_menu_Strings()
{
	...
	CDC_Tx_FS((uint8_t*)L00_menu_items_row2,strlen((const char*)L00_menu_items_row2));
	CDC_Tx_FS((uint8_t*)L10_menu_items_row3,strlen((const char*)L10_menu_items_row3));
	CDC_Tx_FS((uint8_t*)L00_menu_items_row4,strlen((const char*)L00_menu_items_row4));
#if (CHG_HW_VER)
	CDC_Tx_FS((uint8_t*)L00_menu_items_row5,strlen((const char*)L00_menu_items_row5));
#endif
#if (CHG_FW_VER)
	CDC_Tx_FS((uint8_t*)L00_menu_items_row6,strlen((const char*)L00_menu_items_row6));
#endif
	CDC_Tx_FS((uint8_t*)L00_menu_items_row7,strlen((const char*)L00_menu_items_row7));
	CDC_Tx_FS((uint8_t*)L00_menu_items_row8,strlen((const char*)L00_menu_items_row8));
	CDC_Tx_FS((uint8_t*)L00_menu_items_row9,strlen((const char*)L00_menu_items_row9));
	CDC_Tx_FS((uint8_t*)L00_menu_items_row10,strlen((const char*)L00_menu_items_row10));
	CDC_Tx_FS((uint8_t*)L00_menu_items_row11,strlen((const char*)L00_menu_items_row11));
	CDC_Tx_FS((uint8_t*)L10_menu_items_row3,strlen((const char*)L10_menu_items_row3));
	CDC_Tx_FS((uint8_t*)top_menu_items_row9,strlen((const char*)top_menu_items_row9));
}
...
void L00_menu()
{
	...
	do
	{
		len1 = (uint8_t)app.usblen;	//We need to save the receive buffer pointer
		if (len1 == 0)		//because it is used in the main application
			len1 = 1;
		sel = app.usbbuf[len1-1];
...
//	CDC_Tx_FS((uint8_t*)L50_menu_items_row5a,strlen((const char*)L50_menu_items_row5a));
//	CDC_Tx_FS((uint8_t*)L50_menu_items_row5b,strlen((const char*)L50_menu_items_row5b));
//	CDC_Tx_FS((uint8_t*)L50_menu_items_row6a,strlen((const char*)L50_menu_items_row6a));
//	CDC_Tx_FS((uint8_t*)L50_menu_items_row6b,strlen((const char*)L50_menu_items_row6b));
//	CDC_Tx_FS((uint8_t*)L50_menu_items_row7a,strlen((const char*)L50_menu_items_row7a));
//	CDC_Tx_FS((uint8_t*)L50_menu_items_row7b,strlen((const char*)L50_menu_items_row7b));
//	CDC_Tx_FS((uint8_t*)L50_menu_items_row4a,strlen((const char*)L50_menu_items_row4a));
//	CDC_Tx_FS((uint8_t*)L50_menu_items_row4b,strlen((const char*)L50_menu_items_row4b));
