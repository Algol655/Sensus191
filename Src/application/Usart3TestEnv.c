...
void USART3_Tx(const uint8_t *Buffer, uint16_t Length)
{
...
{
#if	(INPUT_TEST==1)
	USART3_Tx((uint8_t*)L20_menu_items_row5,strlen((const char*)L20_menu_items_row5));
	USART3_Tx((uint8_t*)L20_menu_items_row4,strlen((const char*)L20_menu_items_row4));
	USART3_Tx((uint8_t*)L20_menu_items_row7,strlen((const char*)L20_menu_items_row7));
	USART3_Tx((uint8_t*)L20_menu_items_row4,strlen((const char*)L20_menu_items_row4));
#endif
}
...
void GetNumericString(bool nopoint, bool nominus)
{
	...
	do
	{
		Char = (char)usart3app.usartbuf[usart3app.usartlen-1];
		switch (Char)
		{
			case 0x41 ... 0x5A:
			case 0x61 ... 0x7A:
			{
				mystring3[j] = usart3app.usartbuf[usart3app.usartlen-1];
			...
			case 0x1B:	// 'Escape'
			{
				usart3app.usartbuf[usart3app.usartlen-1] = 0x04;
			}
			break;
			default:
	...
	} while ((usart3app.usartbuf[usart3app.usartlen-1] != 0x04) && (usart3app.usartbuf[usart3app.usartlen-1] != 0x1B));
...
#endif
#if	(INPUT_TEST==1)
	USART3_Tx((uint8_t*)top_menu_items_row5,strlen((const char*)top_menu_items_row5));
#endif
#if	(CAN1_TEST==1)
    HAL_NVIC_DisableIRQ(CAN1_TX_IRQn);
    HAL_NVIC_DisableIRQ(CAN1_RX0_IRQn);
	USART3_Tx((uint8_t*)top_menu_items_row6,strlen((const char*)top_menu_items_row6));
#endif
#if	(CAN2_TEST==1)
	HAL_NVIC_DisableIRQ(CAN2_TX_IRQn);
	HAL_NVIC_DisableIRQ(CAN2_RX0_IRQn);
	USART3_Tx((uint8_t*)top_menu_items_row7,strlen((const char*)top_menu_items_row7));
#endif
#if	(ANALOG_TEST==1)
	USART3_Tx((uint8_t*)top_menu_items_row8,strlen((const char*)top_menu_items_row8));
#endif
#if	(FW_UPDATE==1)
	USART3_Tx((uint8_t*)top_menu_items_row10,strlen((const char*)top_menu_items_row10));
#endif
#if	(BLE_SUPPORT==1)
	USART3_Tx((uint8_t*)top_menu_items_row12,strlen((const char*)top_menu_items_row12));
#endif
#if	(UTILITIES==1)
	USART3_Tx((uint8_t*)top_menu_items_row13,strlen((const char*)top_menu_items_row13));
#endif
	USART3_Tx((uint8_t*)top_menu_items_row3,strlen((const char*)top_menu_items_row3));
	...
	do
	{
		...
		switch (sel)
		{
			...
			case 0x1B:
				...
				USART3_Tx((uint8_t*)mystring4,strlen((const char*)mystring4));
				FirstTime = true;
				Test_Mode = false;
				Test_InputMode = false;
//				leds_test = false;
...
void L10_menu()
{
	...
	USART3_Tx((uint8_t*)L10_menu_items_row3,strlen((const char*)L10_menu_items_row3));
	USART3_Tx((uint8_t*)L10_menu_items_row4,strlen((const char*)L10_menu_items_row4));
	USART3_Tx((uint8_t*)L10_menu_items_row5,strlen((const char*)L10_menu_items_row5));
	USART3_Tx((uint8_t*)L10_menu_items_row3,strlen((const char*)L10_menu_items_row3));
	USART3_Tx((uint8_t*)top_menu_items_row9,strlen((const char*)top_menu_items_row9));
	do
	{
...
void L11_menu()
{
	...
	USART3_Tx((uint8_t*)L10_menu_items_row3,strlen((const char*)L10_menu_items_row3));
	USART3_Tx((uint8_t*)L11_menu_items_row4,strlen((const char*)L11_menu_items_row4));
	USART3_Tx((uint8_t*)L11_menu_items_row5,strlen((const char*)L11_menu_items_row5));
	USART3_Tx((uint8_t*)L10_menu_items_row3,strlen((const char*)L10_menu_items_row3));
	USART3_Tx((uint8_t*)top_menu_items_row9,strlen((const char*)top_menu_items_row9));
	do
	{
...
void L12_menu()
{
	...
	USART3_Tx((uint8_t*)L10_menu_items_row3,strlen((const char*)L10_menu_items_row3));
	USART3_Tx((uint8_t*)L12_menu_items_row4,strlen((const char*)L12_menu_items_row4));
	USART3_Tx((uint8_t*)L12_menu_items_row5,strlen((const char*)L12_menu_items_row5));
	USART3_Tx((uint8_t*)L12_menu_items_row6,strlen((const char*)L12_menu_items_row6));
	USART3_Tx((uint8_t*)L10_menu_items_row3,strlen((const char*)L10_menu_items_row3));
	USART3_Tx((uint8_t*)top_menu_items_row9,strlen((const char*)top_menu_items_row9));
	do
	{
...
void L50_menu()
{
	...
	USART3_Tx((uint8_t*)L50_menu_items_row2b,strlen((const char*)L50_menu_items_row2b));
	USART3_Tx((uint8_t*)L50_menu_items_row3a,strlen((const char*)L50_menu_items_row3a));
...
//	conversion_ended = false;
	...
	USART3_Tx((uint8_t*)mystring5,strlen((const char*)mystring5));
	GetNumericString(false, false);
	if (strlen((const char*)(mystring3)))
	{
		if (!((strcmp((const char*)mystring3, "y")) && (strcmp((const char*)mystring3, "Y"))))
		{
			USART3_Tx((uint8_t*)mystring6,strlen((const char*)mystring6));
...
void L70_menu_Strings()
{
	...
	USART3_Tx((uint8_t*)mystring21a,strlen((const char*)mystring21a));
	...
	USART3_Tx((uint8_t*)ascii_val1,strlen((const char*)ascii_val1));
	USART3_Tx((uint8_t*)mystring21b,strlen((const char*)mystring21b));
}
...
//		FlashDataOrg.b_status.s12 = (uint32_t)(xtoi((const char*)mystring3));
	...
	if (usart3app.usartbuf[usart3app.usartlen-1] == 0x04)
	{
		if (updated)
		{
			updated = false;
...
{
	USART3_Tx((uint8_t*)L10_menu_items_row1,strlen((const char*)L10_menu_items_row1));
	USART3_Tx((uint8_t*)L80_menu_items_row2,strlen((const char*)L80_menu_items_row2));
	USART3_Tx((uint8_t*)L10_menu_items_row3,strlen((const char*)L10_menu_items_row3));
#if (SET_DATE_TIME==1)
...
#endif
#if (PRESSURE_SENSOR_PRESENT==1)
	USART3_Tx((uint8_t*)L80_menu_items_row6,strlen((const char*)L80_menu_items_row6));
#endif
#if (HUMIDITY_SENSOR_PRESENT==1)
	USART3_Tx((uint8_t*)L80_menu_items_row7,strlen((const char*)L80_menu_items_row7));
#endif
#if (VOC_SENSOR_PRESENT)
	USART3_Tx((uint8_t*)L80_menu_items_row8,strlen((const char*)L80_menu_items_row8));
#endif
#if (GAS_SENSOR_MODULE_PRESENT==1)
	USART3_Tx((uint8_t*)L80_menu_items_row9,strlen((const char*)L80_menu_items_row9));
	USART3_Tx((uint8_t*)L80_menu_items_row10,strlen((const char*)L80_menu_items_row10));
	USART3_Tx((uint8_t*)L80_menu_items_row11,strlen((const char*)L80_menu_items_row11));
	USART3_Tx((uint8_t*)L80_menu_items_row12,strlen((const char*)L80_menu_items_row12));
#if (OUTDOOR_MODE)
	USART3_Tx((uint8_t*)L80_menu_items_row13,strlen((const char*)L80_menu_items_row13));
	USART3_Tx((uint8_t*)L80_menu_items_row14,strlen((const char*)L80_menu_items_row14));
...
#endif
#if (UWB_MODE==1)
	USART3_Tx((uint8_t*)L80_menu_items_row21,strlen((const char*)L80_menu_items_row21));
	USART3_Tx((uint8_t*)L80_menu_items_row22,strlen((const char*)L80_menu_items_row22));
#elif (PWR_NODE_MODE==1)
	USART3_Tx((uint8_t*)L80_menu_items_row21,strlen((const char*)L80_menu_items_row21));
#endif
	USART3_Tx((uint8_t*)L10_menu_items_row3,strlen((const char*)L10_menu_items_row3));
...
//	extern ANLG_MeasureTypeDef_st GAS_Values;
	...
	do
	{
		...
		switch (sel)
		{
			...
			case 0x31:
				...
				do
				{
					sel1 = usart3app.usartbuf[usart3app.usartlen];	//The "usart3_run()" function must use the
	...
	#endif
						send_usart3message(&dataseq[0], Message_Length);
						SendCntrlMsg = false;
					}
					usart3_run();
