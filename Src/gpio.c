...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, RS_LCD_Pin|SEL_1_Pin|SEL_2_Pin|IO_CONN2_Pin
                          |SEL_0_Pin|D1_LCD_BLE_RST_Pin|PC_12_LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, RESTART_Pin|SEL_3_Pin|D4_LCD_SPI2_NSS_Pin|D6_LCD_SPI2_MISO_Pin
                          |IO_CONN1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(EN_LCD_GPIO_Port, EN_LCD_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : RS_LCD_Pin SEL_1_Pin SEL_2_Pin SEL_0_Pin
                           PC_12_LED_Pin */
  GPIO_InitStruct.Pin = RS_LCD_Pin|SEL_1_Pin|SEL_2_Pin|SEL_0_Pin
                          |PC_12_LED_Pin;
  ...
  /*Configure GPIO pin : IO_EXP_INT_Pin */
  ...
  /*Configure GPIO pin : D3_LCD_BLE_INT_Pin */
  GPIO_InitStruct.Pin = D3_LCD_BLE_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(D3_LCD_BLE_INT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : D2_LCD_BLE_CS_Pin IO_CONN2_Pin D1_LCD_BLE_RST_Pin */
  GPIO_InitStruct.Pin = D2_LCD_BLE_CS_Pin|IO_CONN2_Pin|D1_LCD_BLE_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : RESTART_Pin */
  ...
  /*Configure GPIO pins : SEL_3_Pin D4_LCD_SPI2_NSS_Pin D6_LCD_SPI2_MISO_Pin */
  ...
  /*Configure GPIO pin : IO_CONN1_Pin */
