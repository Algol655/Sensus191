...
/* Private defines -----------------------------------------------------------*/
#define RTC_AF1_Pin GPIO_PIN_13
#define RTC_AF1_GPIO_Port GPIOC
...
#define IO_CONN2_Pin GPIO_PIN_7
...
#define IO_CONN1_Pin GPIO_PIN_5
...
#define SENSOR_REMOTE_MODE	(((BLE_SUPPORT) && (BEACON_APP)) || ((LoRa_SUPPORT) && (SENSOR_END_NODE_APP)))
